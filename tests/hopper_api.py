...
# NOTE: THIS FILE IS FOR REFERENCE AND TYPE SAFETY ONLY! HOPPER INJECTS ITS OWN VERSION OF THIS FILE. DO NOT MODIFY!
#
# This file extracted from Hopper version 5.19.6,
...
class Procedure:
    ...
    def basicBlockIterator(self):
        ...
        for index in range(self.getBasicBlockCount()):
    ...
    def tagIterator(self):
        ...
        for index in range(self.getTagCount()):
...
class Segment:
    ...
    def getSectionsList(self):
        ...
        return [self.getSection(x) for x in range(self.getSectionCount())]
    ...
    def readUInt16LE(self,addr):
        ...
        return struct.unpack("<H", self.readBytes(addr, 2))[0]
    ...
    def setTypeAtAddress(self,addr,length,typeValue):
        ...
        """You cannot use this method for alignments. Please use <b>makeAlignment</b> instead."""
        return HopperLowLevel.setTypeAtAddress(self.__internal_segment_addr__,addr,length,typeValue)
    def makeAlignment(self,addr,size):
        """Create an alignment at a given address so that the next address is a multiple of size."""
        """Size can only be 2, 4, 8, 16, 32 or 64."""
        return HopperLowLevel.makeAlignment(self.__internal_segment_addr__,addr,size)
    ...
    def getStringCount(self):
        ...
        return HopperLowLevel.getStringCount(self.__internal_segment_addr__)
    def getStringAtIndex(self,index):
        """Return the nth string of the segment."""
        return HopperLowLevel.getStringAtIndex(self.__internal_segment_addr__,index)
    def getStringAddressAtIndex(self,index):
        """Return the address of the nth string of the segment."""
        return HopperLowLevel.getStringAddressAtIndex(self.__internal_segment_addr__,index)
    def getStringsList(self):
        """Returns a list containing all the strings and there address as a tuple."""
        return [(self.getStringAddressAtIndex(x), self.getStringAtIndex(x)) for x in range(self.getStringCount())]
...
class Document:
    ...
    def message(msg,buttons):
        ...
        if not isinstance(buttons,list):
            raise TypeError
        return HopperLowLevel.message(msg,list(map(lambda x: x.encode("utf-8"), buttons)))
    ...
    def rebase(self,new_base_address):
        """Change the file base address."""
        HopperLowLevel.rebase(self.__internal_document_addr__,new_base_address)
    ...
    def getSegmentsList(self):
        ...
        return [self.getSegment(x) for x in range(self.getSegmentCount())]
    ...
    def tagIteratorAtAddress(self,addr):
        ...
        for index in range(self.getTagCountAtAddress(addr)):
    ...
    def setBookmarkAtAddress(self,address,name=None):
        """Set a bookmark at a given address, with an optional name."""
        return HopperLowLevel.setBookmark(self.__internal_document_addr__,address,name)
    def removeBookmarkAtAddress(self,address):
        """Removes a bookmark at a given address."""
        return HopperLowLevel.removeBookmark(self.__internal_document_addr__,address)
    def hasBookmarkAtAddress(self,address):
        """Returns True if a bookmark is present at a given address."""
        return HopperLowLevel.hasBookmark(self.__internal_document_addr__,address)
    def renameBookmarkAtAddress(self,address,name):
        """Changes the name of an existing bookmark."""
        return HopperLowLevel.renameBookmark(self.__internal_document_addr__,address,name)
    def findBookmarkWithName(self,name):
        """Returns a list of all bookmarks of a given name."""
        return HopperLowLevel.findBookmark(self.__internal_document_addr__,name)
    def getBookmarkName(self,address):
        """Returns the name of a bookmark at a given address."""
        return HopperLowLevel.bookmarkName(self.__internal_document_addr__,address)
    def getBookmarks(self):
        """Returns a list of all the addresses with a bookmark."""
        return HopperLowLevel.bookmarks(self.__internal_document_addr__)
